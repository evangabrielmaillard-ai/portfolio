...
- +140k€ generated in 2 months via CRM follow-up automation
- Conversion rate doubled (20% → 40%)
- ~4 quotes/day automated with <5% error rate
- SEO: keyword “diable” moved from around position 50 to 7
- Internal tools used by the whole marketing team to remove repetitive work
